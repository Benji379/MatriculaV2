...
public class Proceso {
    ...
    public static void setPanelBackgroundColors(JPanel panel) {
        Color normalColor = panel.getBackground();

        panel.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel.setBackground(MODELO.Config.C1);
            }
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                panel.setBackground(MODELO.Config.C5);
            }
    ...
    public static void mostrarVentanEmergente(JPanel panel) {
        // Crear un JDialog
        JDialog dialog = new JDialog();
        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        dialog.setSize(613, 634);
    ...
    public static void capturePanel(JPanel panel, File outputDirectory, String fileName) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Horario Descargado");
        } catch (IOException e) {
