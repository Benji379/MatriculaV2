...
public class ControladorApoderado {
    ...
    public void consultar() {
        data.consultar(a.tablaApoderado);
    }
    ...
    public void exportar() {
        Proceso.exportarTablaXlsx((DefaultTableModel) a.tablaApoderado.getModel(), "Apoderados", MODELO.Config.C3);
    }
